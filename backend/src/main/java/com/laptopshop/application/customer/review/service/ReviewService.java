package com.laptopshop.application.customer.review.service;

import com.laptopshop.application.customer.review.dto.CreateReviewRequest;
import com.laptopshop.application.customer.review.dto.ProductReviewSummary;
import com.laptopshop.application.customer.review.dto.ReviewResponse;
...
public class ReviewService {
    ...
    public ReviewResponse createReview(Long userId, CreateReviewRequest request) {
        ...
        review.setIsVerified(orderItem != null);
    ...
    public ProductReviewSummary getProductReviews(Long productId, int page, int size) {
        ...
        return new ProductReviewSummary(
                avgRating,
                totalReviews,
                ProductReviewSummary.ReviewPageData.from(reviews)
        );
    }
}
