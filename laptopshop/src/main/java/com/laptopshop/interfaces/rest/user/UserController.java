...
import com.laptopshop.application.customer.user.dto.*;
import com.laptopshop.application.customer.user.service.UserDashboardService;
import com.laptopshop.application.customer.user.service.UserService;
...
public class UserController {
     ...
     *
     * Trả về toàn bộ data ProfilePage cần trong 1 request:
     *   profile, orderSummary (tổng đơn + chi tiêu + hạng),
     *   addresses, wishlist, recentOrders (5 đơn gần nhất)
     */
    @GetMapping("/dashboard")
    public ResponseEntity<UserDashboardResponse> getDashboard(Authentication auth) {
